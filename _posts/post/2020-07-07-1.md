---
layout: post
title: Rails 5アップデートへの道
outline: >
  Railsのメジャーバージョンアップは毎回大幅なアップデートが含まれているため、アップデート作業がたいへんになることがあります。
  今回はとあるアプリケーションをRails 4.2.xからRails 5.0.0.1へアップデートしたので、その記録を備忘として残しておきます。
categories:
  - development
tags:
  - Ruby
...
Rails 5へのアップデートの原因切り分けのため、この時点でご自身のRailsアプリケーションのテストがすべて通過していることを確認します。
...
みなさんもRails 5にアップデートをして、ステキなRails 5ライフをお送りください。
