...
そのパスコードと一致した場合、サイトにログインできるようにします。

認証機能は、インフラ基盤としてFirebaseを使用している場合、Firebase Authenticationを選択することが多いですが、今回はGCPの[Identity Platform](https://cloud.google.com/identity-platform)を選択しました。
...
これをFirebase Authenticationdで実現する場合、
