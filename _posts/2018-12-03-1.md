...
そんな中、 2018 年 1 月に満を持して Google 社が Google Apps Script をローカル環境で開発するための CLI となる `clasp` を [NPM ライブラリ](https://www.npmjs.com/package/@google/clasp)としてかつ [OSS]((https://github.com/google/clasp) で提供を開始しました。
