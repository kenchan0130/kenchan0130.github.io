...
description: iOSアプリケーションを開発しているとシミュレータでデバックすることが多くあります。 しかし、通常では画面が大きくない場合、開発しているエディタとシミュレータをスイッチする必要があります。 今回は、隠し機能を使用し、1つの画面で効率よくiOSアプリ開発を行う方法を紹介します。 また、合わせてその他の隠し機能も一部紹介します。
...
![iOS シミュレータの隠し機能の有効化確認](/assets/posts/post/2018-07-16-1/launch_ios_simulator.png)
...
| 手順                                               | イメージ                                                                                     |
| ------------------------------------------------ | ---------------------------------------------------------------------------------------- |
| メニューバーの「Internal > Allow Fullscreen Mode」を選択します。 | ![Intrenal の Allow FullScreen Mode](/assets/posts/post/2018-07-16-1/internal_allow_fullscreen_mode.png) |
| アプリケーションの緑のボタンを長押します。                            | ![アプリケーションの緑ボタンの長押し](/assets/posts/post/2018-07-16-1/long_press_green_button.png)                       |
| iOSシミュレータを選択します。                                 | ![分割画面における iOS シミュレータの選択](/assets/posts/post/2018-07-16-1/other_select_in_split_view.png)               |

これにより画面が分割され、1つの画面で開発が可能となりました。

![分割画面での iOS アプリケーション開発](/assets/posts/post/2018-07-16-1/split_view_development.png)
...
| 機能                         | 挙動                                                                                    |
| :------------------------: | :-----------------------------------------------------------------------------------: |
| **タッチイベントを表示する機能**         | ![タッチイベントを表示する機能](/assets/posts/post/2018-07-16-1/internal_function_show_single_touches.png)         |
| **ピンチジェスチャを表示する機能**        | ![ピンチジェスチャーを表示する機能](/assets/posts/post/2018-07-16-1/internal_function_show_pinch_gesture.gif)        |
| **ピンチのピポットポイントを表示する機能**    | ![ピンチのピポットポイントを表示する機能](/assets/posts/post/2018-07-16-1/internal_function_show_pinch_pivot_point.png) |
| **エッジジェスチャをハイライトする機能**     | ![エッジジェスチャーをハイライトする機能](/assets/posts/post/2018-07-16-1/internal_function_highlight_edge_gesture.gif) |
| **UIのコンテンツ枠を表示する機能**       | ![UI のコンテンツ枠を表示する機能](/assets/posts/post/2018-07-16-1/internal_function_show_chrome_ui_rects.png)     |
| **シミュレータのベゼルを任意の色に変更する機能** | ![シミュレータのベゼルを任意の色に変更する機能](/assets/posts/post/2018-07-16-1/internal_function_change_bezels_color.png) |
