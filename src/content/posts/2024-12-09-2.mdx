...
description: これまで、管理下にあるmacOSに最新バーションのアプリケーションをインストールするスクリプトである、Installomatorに関していくつか記事を投稿してきました。 今回はいままで紹介してきた内容を応用して、Installomatorでサポートされていないアプリケーションをインストールする方法を紹介します。
...
* [Jamf ProとInstallomatorで常に最新のアプリケーションを配布する](/post/2020-10-12-1)
* [Installomatorのパラメータの紹介](/post/2024-12-09-1)
...
![InstallomatorでOkta VerifyをJamf Proのポリシーでインストールするための設定例](/assets/posts/post/2024-12-09-2/okta_verify_using_installomator_with_jamf_pro.png)
...
![InstallomatorでOkta VerifyをJamf ProのポリシーでappNewVersionを考慮してインストールするための設定例](/assets/posts/post/2024-12-09-2/okta_verify_using_installomator_with_jamf_pro_appnewversion.png)
