...
description: 日本時間2022年6月10日〜6月14日にかけて、Apple社が主催するWWDC（世界開発者会議）2024が開催されました。 今回は、WWDC 2024で紹介されたいくつかのエンタープライズ関連な機能をまとめてみました。
...
![What's new in device managementのセッションで発表された、Apple Business Manager/Apple School Managerにおけるアクティベーションロックの管理機能強化について](/assets/posts/post/2024-06-19-1/manage_activation_lock.png)
...
![What's new in device managementのセッションで発表された、Apple Business Manager/Apple School ManagerにおけるManaged Apple Account（旧Managed Apple ID）のドメイン制限について](/assets/posts/post/2024-06-19-1/domain_capture.png)
...
![What's new in device managementのセッションで発表された、Apple Business Manager/Apple School Managerにおける既存のApple AccountのManaged Apple Accountへの変換について](/assets/posts/post/2024-06-19-1/account_transfer.png)
...
![What's new in device managementのセッションで発表された、macOSのセットアップアシスタントのスキップできる項目の追加](/assets/posts/post/2024-06-19-1/automated_device_enrollment.png)
...
![What's new in device managementのセッションで発表された、Apple Business Manager/Apple School Managerにおけるベータプログラムへのアップデート管理について](/assets/posts/post/2024-06-19-1/manage_beta_updates.png)
...
![What's new in device managementのセッションで発表された、Apple Business Manager/Apple School Managerにおける自動デバイス登録におけるベータプログラムの選択について](/assets/posts/post/2024-06-19-1/manage_beta_updates_in_setup_assistant.png)
...
![What's new in device managementのセッションで発表された、iOS/iPadOSのソフトウェアアップデートの仕組みの刷新について](/assets/posts/post/2024-06-19-1/software_update_settings.png)
...
![What's new in device managementのセッションで発表された、Safariの拡張機能の管理について](/assets/posts/post/2024-06-19-1/manage_safari_extensions.png)
...
![What's new in device managementのセッションで発表された、iOS/iPadOSのセルラーに関するアップデート](/assets/posts/post/2024-06-19-1/cellular_updates.png)
...
![What's new in device managementのセッションで発表された、iOS/iPadOSのアプリケーションのロックとアプリケーションの非表示機能の管理](/assets/posts/post/2024-06-19-1/locking_and_hiding_apps.png)
...
![What's new in device managementのセッションで発表された、iOS/iPadOSの盗難防止機能について](/assets/posts/post/2024-06-19-1/stolen_device_protection.png)
...
![What's new in device managementのセッションで発表された、iOS/iPadOSのin-houseアプリケーションの信頼について](/assets/posts/post/2024-06-19-1/trust_in_house_apps.png)
...
![What's new in device managementのセッションで発表された、macOSの自動デバイス登録におけるWebAuthnのサポート](/assets/posts/post/2024-06-19-1/automated_device_enrollment.png)
...
![What's new in device managementのセッションで発表された、macOSのサービス構成ファイルに関するアップデート](/assets/posts/post/2024-06-19-1/services_configuration.png)
...
![What's new in device managementのセッションで発表された、macOSのディスク管理設定について](/assets/posts/post/2024-06-19-1/disk_management_configuration.png)
...
![What's new in device managementのセッションで発表された、macOSのPlatform Single Sign-Onの機能強化について](/assets/posts/post/2024-06-19-1/platform_single_sign_on.png)
...
![What's new in device managementのセッションで発表された、macOSのシステム設定の構成プロファイルの表示場所の変更について](/assets/posts/post/2024-06-19-1/device_management_in_system_settings.png)
...
![What's new in privacyのセッションで発表された、macOSへのRotate Wi-Fi address機能の導入について](/assets/posts/post/2024-06-19-1/rotate_wifi_address_for_macos.png)
...
![What's new in device managementのセッションで発表された、自動デバイス登録について](/assets/posts/post/2024-06-19-1/automated_device_enrollment.png)
...
![What's new in device managementのセッションで発表された、visionOSのMDM機能の拡充について](/assets/posts/post/2024-06-19-1/expanding_visionos_mdm.png)
