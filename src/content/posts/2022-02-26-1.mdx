...
description: macOSにSystem Extensionが登場してから、管理されているmacOSにおけるSystem Extensionの知見があまり見受けられなかったため、備忘を兼ねて記載していこうと思います。
...
![Jamf Proにおける構成プロファイルのSystem Extension設定](/assets/posts/post/2022-02-26-1/jamf_pro_configuration_profile_system_exntensions.png)
...
![Jamf Proにおける構成プロファイルのSystem Extensionの設定 - Microsoft Defender for Endpointのケース](/assets/posts/post/2022-02-26-1/jamf_configration_profile_system_extension_mdatp_sample.png)
