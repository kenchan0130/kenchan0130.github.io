...
description: 2021年10月23日、24日にデザインカンファレンスである、Designship 2021が開催されました。 今回はこのライブ配信サイトを開発する際に技術的に工夫した内容などを紹介します。
...
![Identity Plartformを使用した構成図](/assets/posts/post/2021-10-29-1/identity_platform_diagram.png)
...
![GitHub Actionsでのworkflow_dispatchでのデプロイ](/assets/posts/post/2021-10-29-1/deploy_on_github_actions_by_workflow_dispatch.png)
...
![Callable HTTPS Functionが呼び出しができない状態 at GCPコンソール](/assets/posts/post/2021-10-29-1/callable_https_function_non_allowed_all_users_at_gcp_console.png)

この問題は、**Cloud Functions 起動元**ロールに**allUsers**プリンシパルを設定した権限を、該当のCloud Functionsに付与することで解決しました。

![Callable HTTPS Functionが呼び出しができる状態 at GCPコンソール](/assets/posts/post/2021-10-29-1/callable_https_function_allowed_all_users_at_gcp_console.png)
