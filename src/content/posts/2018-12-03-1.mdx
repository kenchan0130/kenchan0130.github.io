...
description: Google Apps Script (GAS) はGoogle SpreadsheetやGmailなどのGoogleアプリの拡張または、 単体でサーバーのプロビジョニングや管理なしでスクリプト実行が可能な JavaScriptライクな言語または軽量アプリケーションです。 今回はGoogle Apps Scriptのモダンな開発方法を調査・検討を行ったため、その記録を備忘として残します。
...
![Script Editor from ToolBar](/assets/posts/post/2018-12-03-1/script_editor_from_toolbar.png)
![Google Drive Add App](/assets/posts/post/2018-12-03-1/google_drive_add_app.png)
...
![エディタから実行の例](/assets/posts/post/2018-12-03-1/run_script_from_manual.png)
...
![時間トリガーの選択](/assets/posts/post/2018-12-03-1/time_base_trigger_type_selection.png)
...
![Google カレンダーの予定更新トリガーの設定](/assets/posts/post/2018-12-03-1/calendar_trigger_settings.png)
...
![claspとTypeScriptを使用してGoogle Apps Scriptのプロジェクトにpushした例](/assets/posts/post/2018-12-03-1/clasp_push_with_typescript.png)
