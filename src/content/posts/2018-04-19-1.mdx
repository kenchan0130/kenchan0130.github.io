...
description: IT企業にはおなじみの Atlassian社のConfluence。 有料プラグインも豊富ですが、人数に比例して課金されるため、使用しない人数分のライセンス費用も払わないといけないとなりどんどん導入が難しくなってくることもあります。 今回はちょっとしたプラグインであれば、お金をかけずに拡張できるユーザーマクロを紹介します。
...
![マクロ本文の例](/assets/posts/post/2018-04-19-1/macro_body_example.png)

#### No macro body
マクロ本文が必要ない際に使用します。

![マクロ本文なしの例](/assets/posts/post/2018-04-19-1/no_macro_body_example.png)

#### Escaped
マクロ本文のHTMLをエスケープする際に設定します。

![エスケープ済みのイメージ1](/assets/posts/post/2018-04-19-1/macro_body_escape_image.png)
![エスケープ済みのイメージ2](/assets/posts/post/2018-04-19-1/macro_body_escape_image_rendered.png)
...
![ユーザーマクロブラウザの作成](/assets/posts/post/2018-04-19-1/create_user_macro_browser.png)

アイコンのURLを指定しておくと、ユーザーマクロを選択する際に視認性が増す効果があります。

![ユーザーマクロの設定](/assets/posts/post/2018-04-19-1/user_macro_setting.png)
