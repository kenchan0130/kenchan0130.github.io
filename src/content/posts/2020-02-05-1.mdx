...
description: Jamf ProはmacOS、iOS、iPadOSおよびtvOSのデバイスを管理するためのプロダクトです。 今回は初回ですので、Jamf Proとは何なのかをざっくりとさらい、Jamf Pro Serverにログインするところまでを解説します。
...
<LinkCard href="https://speakerdeck.com/player/13a9c0e9ea434de282612805a55672f9" />
...
![Jamf Pro Serverの初期設定 ライセンス契約同意画面](/assets/posts/post/2020-02-05-1/licence_agreement.png)

次に、アクティベーションを行うために契約時に伝えた**オーガニゼーション名**と送付されてきた**アクティベーションコード**を入力し、「次へ」ボタンを押します。

![Jamf Pro Serverの初期設定 アクティベーションコードの入力画面](/assets/posts/post/2020-02-05-1/licence_registration.png)
...
![Jamf Pro Serverの初期設定 最初のアカウント作成画面](/assets/posts/post/2020-02-05-1/initial_account_creation.png)

作成が完了するとログイン画面にリダイレクトされるので、先程入力した情報を入れることでJamf Pro Serverにログインができます。

![Jamf Pro Serverのログイン画面](/assets/posts/post/2020-02-05-1/login.png)
...
次回は[Jamf Pro ServerのSSO設定について](/post/2020-02-13-1)紹介しようと思っています。
