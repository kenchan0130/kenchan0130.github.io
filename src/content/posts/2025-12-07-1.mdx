...
description: Microsoft Entra Global Secure Accessは、インターネットへのアクセスを保護するMicrosoft Entra Internet Accessと、社内リソースへの安全なアクセスを提供するMicrosoft Entra Private Accessを統合したSSEソリューションです。 この記事では、Microsoft Entra Internet AccessとMicrosoft Entra Private Accessがどのような仕組みで動作し、何ができるのかについて紹介します。
...
| プラットフォーム | 認証方式 |
|---|---|
| Windows | Entra JoinまたはHybrid Entra Joinの認証情報を使用 |
...
![Microsoft Entra Internet Accessのアーキテクチャ](/assets/posts/post/2025-12-07-1/internet_access_architecture.png)
...
![Microsoft Entra Private Accessのアーキテクチャ](/assets/posts/post/2025-12-07-1/private_access_architecture.png)
