...
description: 日本時間2020年6月23日〜6月27日にかけて、Apple社が主催するWWDC（世界開発者会議）2020が開催されました。 その中で、今年もエンタープライズ機能のアップデートが紹介されました。 今回は、WWDC 2020で紹介されたいくつかの機能をまとめてみました。
...
![What's new in managing Apple devicesのセッションで発表されたAuto Advance for Mac](/assets/posts/post/2020-07-01-1/auto_advance_for_mac.png)
...
![What's new in managing Apple devicesのセッションで発表されたSupervison for User Approved MDM](/assets/posts/post/2020-07-01-1/supervison_for_user_approved_mdm.png)
...
![What's new in managing Apple devicesのセッションで発表されたManaged Software Update](/assets/posts/post/2020-07-01-1/managed_software_update.png)
...
![What's new in managing Apple devicesのセッションで発表されたManaged Mac Apps](/assets/posts/post/2020-07-01-1/managed_mac_apps.png)
...
![What's new in managing Apple devicesのセッションで発表されたContent Caching](/assets/posts/post/2020-07-01-1/content_caching.png)
...
![What's new in managing Apple devicesのセッションで発表されたDownloaded Profiles for Mac](/assets/posts/post/2020-07-01-1/downloaded_profiles_for_mac.png)
...
![What's new in managing Apple devicesのセッションで発表されたnetworrksetup limitations for standard users](/assets/posts/post/2020-07-01-1/networrksetup_limitations_for_standard_users.png)
...
![What's new in managing Apple devicesのセッションで発表されたSerial Number Format Change](/assets/posts/post/2020-07-01-1/serial_number_format_change.png)
...
![What's new in managing Apple devicesのセッションで発表されたLigths Out Management for Mac Pro](/assets/posts/post/2020-07-01-1/ligths_out_management_for_mac_pro.png)
...
![What's new in managing Apple devicesのセッションで発表されたShared iPad](/assets/posts/post/2020-07-01-1/shared_ipad.png)
...
![What's new in managing Apple devicesのセッションで発表されたNon-removable Managed Apps](/assets/posts/post/2020-07-01-1/non_removable_managed_apps.png)
...
![What's new in managing Apple devicesのセッションで発表されたManaged Open in supports Shortcuts](/assets/posts/post/2020-07-01-1/managed_open_in_supports_shortcuts.png)
...
![What's new in managing Apple devicesのセッションで発表されたManaged Notification Previews](/assets/posts/post/2020-07-01-1/managed_notification_previews.png)
...
![What's new in managing Apple devicesのセッションで発表されたEncrypted DNS](/assets/posts/post/2020-07-01-1/encrypted_dns.png)
...
![What's new in managing Apple devicesのセッションで発表されたWi-Fi MAC Address Access Control](/assets/posts/post/2020-07-01-1/wifi_mac_address_access_control.png)
...
![Leverage enterprise identity and authenticationのセッションで発表されたSCIM](/assets/posts/post/2020-07-01-1/scim.png)
