...
![デフォルトのノートブックの設定](/assets/posts/post/2019-12-24-2/notebook_settings_default.png)
...
![ノートブックのアップロード](/assets/posts/post/2019-12-24-2/upload_notebook.png)
![Rが使用できる状態のノートブックの設定](/assets/posts/post/2019-12-24-2/notebook_settings_with_r.png)
...
![Rのバージョン情報を表示](/assets/posts/post/2019-12-24-2/run_r_print_version.png)
...
![ノートブックにファイルをアップロード](/assets/posts/post/2019-12-24-2/notebook_file_upload.png)
...
![data.tableで読みとったCSVのheadの表示](/assets/posts/post/2019-12-24-2/data_table_print_head.png)
...
![各所管ごとの第一種金融取引業者と第二種金融取引業者の合計数](/assets/posts/post/2019-12-24-2/summarised_group_by_shokan.png)
...
![各所管ごとの第一種金融取引業者と第二種金融取引業者の合計数のプロット](/assets/posts/post/2019-12-24-2/summarised_group_by_shokan_plot.png)
