...
description: 日本時間2022年6月7日〜6月11日にかけて、Apple社が主催するWWDC（世界開発者会議）2022が開催されました。 今回は、WWDC 2022で紹介されたいくつかのエンタープライズ関連な機能をまとめてみました。
...
![What's new in managing Apple devicesのセッションで発表された、iOS/iPadOSのApple Configurator for iPhoneによるApple Business Manager/Apple School Managerへのデバイス登録](/assets/posts/post/2022-08-18-1/apple_configurator_for_iphone_supports_ios_and_ipados_device.png)
...
![What's new in managing Apple devicesのセッションで発表された、Managed Apple IDの「Appleでサインイン」サポート](/assets/posts/post/2022-08-18-1/managed_apple_id_supports_sign_in_with_apple.png)
...
![What's new in managing Apple devicesのセッションで発表された、ネットワークトラフィックの管理](/assets/posts/post/2022-08-18-1/managed_per_app_networking.png)
...
![What's new in managing Apple devicesのセッションで発表された、共有iPadの新機能](/assets/posts/post/2022-08-18-1/shared_ipad_new_features.png)
...
![What's new in managing Apple devicesのセッションで発表された、デバイス設定中にアプリケーションをインストール](/assets/posts/post/2022-08-18-1/install_application_during_setup.png)
...
![macOS Venturaがサポートするハードウェア一覧](/assets/posts/post/2022-08-18-1/macos_ventura_support_hardwares.png)
...
![macOS Venturaで導入されるシステム設定](/assets/posts/post/2022-08-18-1/macos_ventura_system_settings.png)
...
![What's new in managing Apple devicesのセッションで発表された、Platform Single Sign-on](/assets/posts/post/2022-08-18-1/platform_sso.png)
...
![What's new in managing Apple devicesのセッションで発表された、OSアップデートコマンドの改善](/assets/posts/post/2022-08-18-1/deploy_software_updates.png)
...
![What's new in managing Apple devicesのセッションで発表された、セットアップアシスタントのネットワーク接続必須化](/assets/posts/post/2022-08-18-1/network_requirement_for_setup_assistant.png)
...
![What's new in managing Apple devicesのセッションで発表された、プロファイルコマンドの変更](/assets/posts/post/2022-08-18-1/profiles_cli_tool.png)
...
![What's new in managing Apple devicesのセッションで発表された、インタラクティブな証明書の信頼](/assets/posts/post/2022-08-18-1/interactive_certificate_trust.png)
...
![What's new in managing Apple devicesのセッションで発表された、アクセサリセキュリティ](/assets/posts/post/2022-08-18-1/accessory_security.png)
...
![What’s new in Endpoint Securityのセッションで発表された、eslogger](/assets/posts/post/2022-08-18-1/eslogger.png)
...
![What's new in managing Apple devicesのセッションで発表された、Rapid Security Response](/assets/posts/post/2022-08-18-1/rapid_security_response.png)
...
![Explore Apple Business Essentialsのセッションで発表された、 Apple Business Essentials](/assets/posts/post/2022-08-18-1/apple_buisiness_essentials.png)
...
![What's new in managing Apple devicesのセッションで発表された、Enrollment Single Sign-on](/assets/posts/post/2022-08-18-1/enrollment_sso.png)
...
![What's new in managing Apple devicesのセッションで発表された、eSIMインストールと制限](/assets/posts/post/2022-08-18-1/esim_installation_and_restriction.png)
...
![Adopt declarative device managementのセッションで発表された、eSIMインストールと制限](/assets/posts/post/2022-08-18-1/platform_and_enrollment_support.png)
...
![Discover Managed Device Attestationのセッションで発表された、eSIMインストールと制限](/assets/posts/post/2022-08-18-1/managed_device_attestation.png)
