...
description: ブラウザのポリシーと言うとActive Directoryでグループポリシーを用意し、Internet Explorerの設定を行うというのはよく聞く話ですが、今回はmacOSの場合はどうすればよいかをSafariとGoogle Chromeを題材として紹介していきます。
...
項目が多いため、[CSV](/assets/posts/post/2018-01-07-1/safari_policies_ja.csv) にまとめました。
...
![プロファイルマネージャーのカスタム設定項目の例](/assets/posts/post/2018-01-07-1/profile_manager_custom_settings_payload.png)
