...
「[kenchan0130 blog](https://kenchan0130.github.io)」（以下「当サイト」という）は、当サイトが行う各種サービスの利用者、および当サイトの事業に関わる審査・選考の関係者から任意に提供される情報を必要な範囲で収集します。個人情報を収集する際は、その目的を明示するとともに、提供者の意思にもとづくことを原則とします。
...
1. [Google Analytics 4](https://marketingplatform.google.com/about/analytics/)
    ...
    * 当サイトでは測定ID `G-B7RX34Q5PL` を使用しています
...
法令上同意が必要な地域では、GoogleのPrivacy & Messagingによる同意管理が表示される場合があります。
...
プライバシーポリシーの改定があったときは、当サイトまたは当サイト管理者の[Xアカウント（@kenchan0130）](https://twitter.com/kenchan0130)またはその両方にて遅滞なく掲載します。

## 個人情報の取り扱いに関する問い合わせ先

当サイトにおける個人情報保護に関してご質問などがある場合は、Xの[@kenchan0130](https://twitter.com/kenchan0130)までご連絡ください。
